...
const DEFAULT_LAYETTE_ITEMS = [
  ...
  { id: 19, name: 'Saídas Maternidade', category: 'ROUPINHAS', recommendedQuantity: 2, startingPrice: 159.90 },
  ...
  { id: 42, name: 'Balde (ofurô)', category: 'HIGIENE', recommendedQuantity: 1, startingPrice:0 },
  ...
  { id: 46, name: 'Absorvente para seio', category: 'HIGIENE', recommendedQuantity: 1, startingPrice:0},
  ...
  { id: 74, name: 'Aspirador Nasal', category: 'HIGIENE', recommendedQuantity: 1, startingPrice: 18.90},
  { id: 75, name: 'Bolsa térmica para cólica', category: 'HIGIENE', recommendedQuantity: 1 },
  { id: 76, name: 'Kit unha (lixa e cortador de unha)', category: 'HIGIENE', recommendedQuantity: 1, optional: true, startingPrice: 15.90  },
  { id: 77, name: 'Kit escova e pente', category: 'HIGIENE', recommendedQuantity: 1, optional: true,startingPrice: 39.90  },
  ...
  { id: 78, name: 'Escova de dentes para massagear', category: 'HIGIENE', recommendedQuantity: 1, startingPrice: 15.90 },
  { id: 79, name: 'Repelente em creme', category: 'HIGIENE', recommendedQuantity: 1, startingPrice: 39.90 },
  { id: 80, name: 'Cotonete', category: 'HIGIENE', recommendedQuantity: 1, startingPrice:0},
  { id: 81, name: 'Algodão', category: 'HIGIENE', recommendedQuantity: 1, startingPrice:0 },
  { id: 82, name: 'Álcool 70 em gel', category: 'HIGIENE', recommendedQuantity: 1 },
  { id: 83, name: 'Pomada de assadura', category: 'HIGIENE', recommendedQuantity: 2, startingPrice:0 },
